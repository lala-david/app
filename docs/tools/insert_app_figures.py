...
PLAN = [
    (33, "이에 사운즈펀 브릿지는", [
        ("text", "이러한 구상을 확인하기 위해 1주차 ‘Colors’ 주제로 앱 시제품을 먼저 제작했습니다. 아동은 그림 1과 같이 오늘의 루틴을 순서대로 따라가며 노래와 챈트를 듣고, 들은 단어를 그림에서 찾은 뒤, 직접 말하면 그림에 색이 입혀지는 말하기 게임 ‘색깔 마법’으로 활동을 마무리합니다. 틀렸다는 표시 대신 다시 들려주고 함께 말해 보도록 하여, 아동이 부담 없이 소리를 내 보는 경험을 쌓도록 했습니다."),
    ]),
    (33, LAST, [
    ...
    (39, " 접근성", [
        ...
        ("bullet", "외부 서비스: 유튜브(검수된 영상 재생), 기기 음성 인식(말하기 확인), 휴대폰 알림(루틴 시작 안내)"),
